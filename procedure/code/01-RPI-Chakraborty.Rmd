...
The socio-demographic/poverty data and the death rate data are grouped by county cluster first. Based on the cluster, we calculated the first order queen continuity, the spatial weight for neighbor's list, and the G statistics before mapping the hotspots and coldspots.
...
The temporal extent of the study is based on the COVID-19 death rate, which covers cases from 1/22/2020-7/2/2022. The study also uses 5 year estimates for county disability and sociodemographic characteristics collected from 2016-2020. This range is not explicitly stated in the original study.

The temporal support for the COVID-19 incidence rate was case data collected from 1/22/2020-7/2/2020. The temporal support for the disability sociodemographic data was data collected from 2016-2020. Temporal effects are not measured or accounted for.

### Data exclusion
There aren't any counties with missing socio-demographic and poverty data from the 2020 ACS. 
